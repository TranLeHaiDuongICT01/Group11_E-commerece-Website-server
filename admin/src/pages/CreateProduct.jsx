...
const CreateProduct = () => {
  ...
  return (
    <Container sx={{ marginTop: '20px' }}>
      <TransitionsModal text='Create product successfully' openModal={openModal} setOpenModal={setOpenModal} />
      <Paper elevation={6} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '20px', marginTop: '20px', padding: '20px' }}>
        ...
        <Box sx={{ width: '100%' }}>
          <form onSubmit={handleSubmit} component={FormControl} style={{
            ...
            <CheckGroup list={categoryList} name='category' data={data} setData={setData} clear={clear} setClear={setClear} />
            <CheckGroup list={sizeList} name='size' data={data} setData={setData} clear={clear} setClear={setClear} />
            <CheckGroup list={colorList} name='color' data={data} setData={setData} clear={clear} setClear={setClear} />
            <div style={{
              position: 'relative',
              display: 'flex',
              flexWrap: 'wrap',
            ...
            <input style={{
              width: '100%'
            }} type="file" name='file' id='file_up' onChange={handleChangeFile} multiple required />
